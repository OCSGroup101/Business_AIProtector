...
def initialize_ca() -> None:
    ...
    if ca_key_pem and ca_cert_pem:
        _ca_key = cast(rsa.RSAPrivateKey, serialization.load_pem_private_key(ca_key_pem.encode(), password=None))
    ...
    if key_path.exists() and cert_path.exists():
        _ca_key = cast(rsa.RSAPrivateKey, serialization.load_pem_private_key(
